            ...
            ${isMobile ? 'absolute z-50 h-full' : 'relative'}`}>
                ...
                <NavLink to='/restaurant/orderboard' className='cursor-pointer'>
                    <div className='flex items-center'>
                        ...
                        {isOpen && <p className='ml-3 text-white font-semibold'>Order Board</p>}
                    </div>
                </NavLink>
                ...
                <NavLink to='/restaurant/setup' className='cursor-pointer'>
                    <div className='flex items-center'>
                        ...
                        {isOpen && <p className='ml-3 text-white font-semibold'>Restaurant Setup</p>}
                    </div>
                </NavLink>
...
export default RestaurantSideMenuBar
